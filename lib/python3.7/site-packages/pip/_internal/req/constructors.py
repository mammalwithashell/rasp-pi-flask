...
def install_req_from_line(
    ...
    if marker_sep in name:
        ...
        markers = None if not markers else Marker(markers)
    else:
        markers = None
    name = name.strip()
    req = None
    ...
    extras = Requirement("placeholder" + extras.lower()).extras if extras else ()
    if req is not None:
        try:
            req = Requirement(req)
        except InvalidRequirement:
            ...
            elif '=' in req and all(op not in req for op in operators):
